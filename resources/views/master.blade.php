  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <div class="row m-3">
        ...
        <div class="col-auto">
          <a class="text-white" href="/dashboard" style="font-weight: bold; text-decoration:none;">SMK AL-HUDA</a>
        </div>
      </div>
      <!-- <a class="navbar-brand" href="">
        <img src="{{asset('assets/img/alhuda.png')}}" alt="" style="width:30px;">
        <a class="text-white" href="/" style="font-weight: bold;">SMK AL-HUDA</a>
      </a> -->
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="{{url('siswa')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="{{url('alternatif')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">receipt_long</i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="{{url('deleteuser')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="{{url('hasil')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
